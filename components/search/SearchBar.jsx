...
import { Search, SlidersHorizontal, X, ChevronDown, Plus, Minus } from 'lucide-react';
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center space-x-3">
                        <Button variant="outline" size="sm" className="w-8 h-8 rounded-full p-0"
                          onClick={() => setAdults(Math.max(0, adults - 1))} disabled={adults <= 0}>
                ...
                <PopoverTrigger asChild>
                  <button className="px-6 py-3 text-left hover:bg-gray-50 flex items-center space-x-2">
                    <div>
                      ...
                      <div className="text-sm text-gray-600">
                        {selectedCategory ? selectedCategory : 'Any type'}
                      </div>
                    </div>
                    <ChevronDown className="w-4 h-4" />
                  </button>
            ...
            <PopoverContent className="w-96 p-0" align="end">
              <div className="p-6 max-h-[600px] overflow-y-auto">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => setShowFilters(false)} className="h-auto p-1">
                    <X className="h-4 w-4" />
                  </Button>
                </div>
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <Button className="bg-[#814193] hover:bg-[#6d3580] text-white" onClick={handleSearch}>
                    Show results
                  </Button>
                </div>
              </div>
