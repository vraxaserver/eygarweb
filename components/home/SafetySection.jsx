            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <div className="flex items-center space-x-2 mb-4">
                        ...
                        <span className="text-sm font-medium text-[#814193]">
                            {t("home.safety_section_badge")}
                        </span>
                    </div>

                    <h2 className="text-3xl font-bold text-gray-900 mb-6">
                        {t("home.safety_section_title")}
                    </h2>

                    <p className="text-gray-600 mb-8">
                        {t("home.safety_section_desc")}
                    </p>
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            >
                                <div
                                    className={`w-8 h-8 ${item.bg} rounded-full flex items-center justify-center flex-shrink-0`}
                                >
                                    {item.icon}
                                </div>
                                <div>
                        ...
                        <div className="absolute bottom-6 left-6 right-6 bg-white rounded-lg p-4 shadow-lg">
                            <div className="flex items-center justify-between mb-2">
                                ...
                                <div className="text-right">
                                    <div className="text-2xl font-bold text-[#814193]">
                                        99.8%
                                    </div>
                            ...
                            <p className="text-xs text-gray-600">
                                Government Compliant • Free Insurance Included
                            </p>
                        </div>
