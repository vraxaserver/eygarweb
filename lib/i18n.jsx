...
export const useTranslation = () => {
    ...
    const translations = {
        en: {
            ...
            "home.safety_section_desc":
                "Experience worry-free travel with our comprehensive safety measures, government compliance, and free insurance coverage for every booking.",
            ...
            "home.safety_certified_host_section_title":
                "Safety-Certified Hosts",
            "home.unique_experience_section_title": "Unique Experiences",
            "home.unique_experience_section_desc":
                "Discover free local experiences offered by our hosts.",
        ...
        ar: {
            ...
            "home.unique_experience_section_desc":
                "اكتشف التجارب المحلية المجانية التي يقدمها مضيفونا.",
