    ...
    useEffect(() => {
        ...
        if (isLoaded && inputRef.current) {
            ...
            autocomplete.addListener("place_changed", () => {
                ...
                if (!place.geometry) {
                    setloc({
                        error: `No details available for input: "${place.name}"`,
                    });
                    return;
                }
                ...
                const cityName = getCityNameFromComponents(
                    place.address_components
                );
                const countryName = getCountryNameFromComponents(
                    place.address_components
                );
